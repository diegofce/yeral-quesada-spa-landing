...
import { SAAS_BOOKING_URL, WHATSAPP_URL } from '@/constants/config';
...
const SERVICIOS_HOME = [
  {
    ...
    descripcion:
      'Elimina impurezas y revitaliza tu piel con técnicas profesionales.',
    precio: 80000,
    icono: Sparkles,
  },
  {
    ...
    descripcion:
      'Hidratación profunda que ilumina y suaviza la piel al instante.',
    precio: 120000,
    icono: Star,
  },
  {
  ...
  },
  {
    ...
    descripcion:
      'Moldea y tonifica tu figura con técnicas corporales avanzadas.',
    precio: 100000,
    icono: Heart,
  },
] as const;
          ...
          {SERVICIOS_HOME.map((servicio) => {
            ...
            return (
              <article key={servicio.id} className="card-luxury relative p-6">
                ...
                <div
                  className="mx-auto mt-3 h-[2px] w-10 rounded"
                  style={{ background: 'var(--gradient-dorado)' }}
                  aria-hidden="true"
                />
                ...
                <p className="mt-5 text-center">
                  <span className="mr-1 text-xs font-semibold uppercase tracking-[0.1em] text-dorado">
                    Desde
                  </span>
                  <span className="font-display text-2xl font-bold text-azul-rey">
